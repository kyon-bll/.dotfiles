...
function zubora -d "zubora 'commit message' [files to add;optional]"
    if test (count $argv) -gt 1
        set_color -o; echo -n \$ git; set_color blue; echo add $argv[2..-1]  
        set_color normal; git add $argv[2..-1]
    else
        set_color -o; echo -n \$ git; set_color blue; echo add -A
        set_color normal; git add -A
    end
    set_color -o; echo -n \$ git; set_color blue; echo -n commit -m; set_color yellow; echo "'"$argv[1]"'"
    set_color normal; git commit -m $argv[1]
    set_color -o; echo -n \$ git; set_color blue; echo push
